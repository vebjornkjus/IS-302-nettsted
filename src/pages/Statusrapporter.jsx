  ...
  const statusReports = [
    {
      ...
      image: "/api/placeholder/400/250", // Placeholder - replace with actual image
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            {statusReports.map(report => (
              <div key={report.id} className="modern-card rounded-xl overflow-hidden group hover:shadow-xl hover:scale-[1.02] transition-all duration-300">
                {/* Image placeholder */}
                <div className="relative h-48 bg-gradient-to-br from-capgemini-100 to-blue-100 dark:from-capgemini-900/30 dark:to-blue-900/30 flex items-center justify-center">
